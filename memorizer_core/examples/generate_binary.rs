use memorizer_core::text::{TextRepresentation, TextTransformation, TextLearnable, save_text_learnables};
...
fn main() -> Result<(), Box<dyn std::error::Error>>
{
    ...
    save_text_learnables("/tmp/output.yaml", "Binary to Dec and vice versa", 1655854159, &learnables)?;
    Ok(())
}